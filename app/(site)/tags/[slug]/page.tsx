  ...
  return (
    <section>
      ...
      {blogs.length > 0 ? (
        ...
        <p className="text-wrap text-xl tracking-wide font-bold leading-none text-gray-500 dark:text-gray-400">
          It looks like there are currently no articles for this category...
        </p>
      )}
    </section>
  );
