...
const ProjectCard = ({ project, idx }: { project: Project; idx: number }) => {
  return (
    <Link
      ...
      target="_blank"
      className={`flex flex-col justify-end rounded-md border border-gray-400 p-3 transition-transform duration-300 ease-linear hover:-translate-y-0.5 dark:border-gray-500 ${idx === 0 || idx === 3 ? "sm:col-span-6" : idx === 1 || idx === 2 ? "sm:col-span-5" : ""}`}
    >
